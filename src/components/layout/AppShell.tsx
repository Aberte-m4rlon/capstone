...
export const PAGE_TITLES: Record<string, { title: string; subtitle: string }> = {
  ...
  '/animals':          { title: 'Kambing at Tupa',      subtitle: 'Pamamahala ng mga kambing at tupa sa bukid' },
  '/health':           { title: 'Health Monitoring',    subtitle: 'Subaybayan ang kalagayan ng bawat kambing at tupa.' },
  '/breeding':         { title: 'Breeding',             subtitle: 'Pagpaparami, pagbubuntis, at panganganak ng kambing at tupa' },
  '/sales':            { title: 'Benta ng Kambing at Tupa', subtitle: 'Pamamahala sa pagbebenta ng kambing at tupa at kita' },
  ...
  '/myai':             { title: 'AI Farm Assistant',    subtitle: 'Katuwang sa pagsasaka at kalusugan ng kambing at tupa' },
  '/camera-screening': { title: 'AI Health Scanner',    subtitle: 'Itutok ang camera sa kambing o tupa.' },
  '/scanner':          { title: 'QR Scanner',           subtitle: 'I-scan ang QR code ng kambing o tupa' },
